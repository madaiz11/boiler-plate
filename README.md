...
2. **Copy** the stack folder you need (e.g. `nest-js/`) into your new project, or reference this repo as a template.
...
- Add or update the matching folder under the repo root (e.g. `nest-js/`, or new `react/`, `next-js/`, etc.).
